...
import 'package:ChatPaLM/widgets/snacksbars.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: const BubbleWorkingPage(),
    );
  }
}

class BubbleWorkingPage extends StatelessWidget {
  const BubbleWorkingPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.transparent,
        title: const Text('Bubble Working Page'),
        centerTitle: true,
      ),
      body: Padding(
